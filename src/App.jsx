...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* ── Sticky header ─────────────────────────────── */}
      <header className="fixed top-0 left-0 w-full z-10 flex items-center justify-between px-6 py-4 bg-black/50 backdrop-blur-sm">
      ...
      {/* everything else gets top padding so it clears header */}
      <div className="pt-24">
        {/* Attributes */}
